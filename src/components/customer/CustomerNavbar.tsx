    ...
    return (
        <header className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
                ...
                {/* Center Section: Responsive Interactive Search Bar */}
                {activeTab === "catalog" && (
                ...
                <div className="flex items-center gap-2 md:gap-4 shrink-0">
                    ...
                    <button
                        onClick={onLogout} // Parent component ka handleLogoutAction trigger karega
                        className="border border-rose-200 text-rose-600 hover:bg-rose-50 transition px-3 py-1.5 rounded-lg text-xs font-bold tracking-wide"
                    >
                        Log Out
                    </button>
